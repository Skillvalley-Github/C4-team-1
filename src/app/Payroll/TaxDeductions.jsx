...
const TaxDeductions = () => {
  return (
    <>
      {/* <div className="flex justify-center fixed z-40 h-16 w-full bg-zinc-700 text-white">
        Your Total Tax = $50213
      </div> */}

      <div className="flex flex-col justify-center overflow-x-hidden px-24 py-6 max-sm:w-screen max-sm:px-6">
        <div className=" w-full rounded-md  border-l-8 border-red-600 bg-red-300 p-6  shadow-xl">
          <div className="">
            <p>
              Please update your{" "}
              <Link
                to={"/dashboard/payroll/taxdeductions/pan-details"}
        ...
        <div className="">
          <PayrollTable
            ...
            rows={Regim.rows}
            buttonLink={"/dashboard/payroll/taxdeductions/regime-selection"}
          />
        </div>
